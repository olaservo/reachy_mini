...
the selected audio devices, and the speaker-EQ band gains. Persisting means a
choice survives reboots and app updates, stays per-user (not shared across OS
